...
class HighSchoolLevelsScreen extends StatelessWidget {
  const HighSchoolLevelsScreen({super.key});
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return LevelItemWidget(
                  title: level['title']!,
                  subtitle: loc.chooseStream,
                  icon: Icons.school_rounded,
                  color: const Color(0xFF9333EA), // Purple-ish
                  index: index,
                  onTap: () {
                    context.push(
                      '/high-streams',
