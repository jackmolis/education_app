/// A "Devoir Libre" (free assignment) belonging to a subject.
///
/// DB table: `devoirs_libres`
/// Fields: id, subject_id, title_en, title_fr, title_ar,
///         description_en, description_fr, description_ar,
///         order_number, created_at
class DevoirLibreModel {
  final String id;
  ...
  factory DevoirLibreModel.fromJson(Map<String, dynamic> json) {
    DateTime? created;
    final rawCreated = json['created_at'];
    if (rawCreated is String) created = DateTime.tryParse(rawCreated);
